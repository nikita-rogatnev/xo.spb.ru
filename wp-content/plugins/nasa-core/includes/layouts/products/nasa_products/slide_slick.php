...
?>
<div class="nasa-wrap-slick-slide-products nasa-nav-slick-wrap" data-id="#nasa-slick-slider-<?php echo esc_attr($id_sc); ?>">
        ...
        <div class="nasa-col large-12 columns">
            <div class="nasa-no-cols group-slider">
                <div
                    ...
                    class="nasa-slick-slider-body-<?php echo esc_attr($id_sc); ?> nasa-slick-slider-title-wrap products grid"
