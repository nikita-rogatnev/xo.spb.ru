...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body #cart-sidebar .cart_sidebar .cart_list .mini-cart-item .mini-cart-info a:hover,
            body #cart-sidebar .cart_sidebar .cart_list .mini-cart-item .item-in-cart:hover i,
            ...
            body #cart-sidebar .cart_sidebar .btn-mini-cart a.btn-viewcart,
            body #cart-sidebar .cart_sidebar .btn-mini-cart a.btn-viewcart:hover,
