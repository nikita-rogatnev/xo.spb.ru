    ...
    class ELESSI_WC_AJAX extends WC_AJAX {
        ...
        public static function nasa_add_ajax_events() {
            ...
            $ajax_events = array(
                ...
                'nasa_quickview_gallery_variation'  => true,
                'nasa_get_gallery_variation'        => true,
                'nasa_get_deal_variation'           => true,
                'nasa_cart_remove_item'             => true,
                'nasa_single_add_to_cart'           => true,
                'nasa_combo_products'               => true,
                'nasa_add_compare_product'          => true,
                'nasa_remove_compare_product'       => true,
                'nasa_remove_all_compare'           => true,
            );
        ...
        public static function nasa_static_content() {
            ...
            // $content['#nasa-cart-sidebar-content'] = elessi_mini_cart_sidebar(true);
         ...
         * Remove item in cart
         */
        public static function nasa_cart_remove_item() {
            global $woocommerce;
