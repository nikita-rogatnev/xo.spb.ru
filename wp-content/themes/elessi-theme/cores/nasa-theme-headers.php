...
if (!function_exists('elessi_header_topbar')) :
    ...
    function elessi_header_topbar() {
         ...
         * Top bar Left
         */
        $topbar_left = (!isset($nasa_opt['topbar_left_show']) || $nasa_opt['topbar_left_show'] == 1 && ((isset($nasa_opt['topbar_left']) && $nasa_opt['topbar_left'] != ''))) ? do_shortcode($nasa_opt['topbar_left']) : '';
